  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected])]:first:rounded-l-md [&:has([aria-selected])]:last:rounded-r-md",
        day_button: cn(
